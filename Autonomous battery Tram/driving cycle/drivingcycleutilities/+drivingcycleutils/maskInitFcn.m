function [S_CYCLE, T_CYCLE, T_MAX, W_SCALE, Disp, Vel, Acc, t, v] = ...
    maskInitFcn(CycleName, CycleRepeatsForever)
%drivingcycleutils.maskInitFcn Block mask InitFcn for drivingcycle_lib.
%   [...] = drivingcycleutils.maskInitFcn(CycleName, CycleRepeatsForever)  
%   is called by the mask initialization function of the drivingcycle_lib  
%   blocks. For further details, please inspect the function body.
