...
Tn = Pmec_eq/rated_speed_motor; % Nominal torque provided by the machine N*m
...
distance = [0,1,1.1,3,3.1,4,4.1,6,6.1,8,8.1,9,9.1,9.9,10];
speed_ref = [speed_tram/2,speed_tram/2, speed_tram,speed_tram,speed_tram,speed_tram,speed_max,speed_max,speed_tram,speed_tram,speed_tram,speed_tram,speed_tram/2,speed_tram/2,0 ];
slope = [3,3,2,0,0,-2,-3,-3,0,0,0,0,0,0,0];
...
%quantity
Ns=100; %cells in serie
Ntot=300; %cells
Np=3; %3 branches in parallel

%complete battery
Cn=Np*Cn1; %Nominal capacity in Ah

%cooling system
A_exchange=0.5; %m^2;
Kair=200; %W/(m^2*K)
Kliquid=2000; %W/(m^2*K)
Gair=Kair*A_exchange; %W/K
Gliquid=Kliquid*A_exchange; %W/K
Cth=240e3; %j/k battery thermal capacity
